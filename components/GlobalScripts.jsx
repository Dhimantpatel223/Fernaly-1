...
export default function GlobalScripts() {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('.product-card, .category-card, .feature-card, .value-card').forEach(el => {
        (el).style.opacity = '0';
    ...
    // Hover effect
    const hoverEnter = function() { this.style.zIndex = '10'; };
    const hoverLeave = function() { this.style.zIndex = '1'; };
